...
# Contador de uso
Invoke-RestMethod -Uri "https://script.google.com/macros/s/AKfycbxCNI2nrcb-mDEMrSi9cmFfrvPBOT3T3MmwnnmNfWnbisdUqZDay59-eok7tg9p9varRg/exec?script=formatei-pc" -ErrorAction SilentlyContinue | Out-Null
